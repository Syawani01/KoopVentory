...
<nav style="justify-content: space-between;align-items:center">
    ...
    <div class="header">
      ...
      <a href="#" class=""  ><h1><b>KoopVentory : Inactive Student</b></h1></a>
    </div>
...
<table style="margin:0 auto; width:85%; background-color:cadetblue">
    <tr>
        <th style="width:30%">List of Previous Student</th>
    </tr>
</table>
...
<table style="margin:0 auto;width:85%;text-align:center;">
    ...
    <?php
    $count=1;
    $query="select login.FullName, login.UserID, studentinfo.email, studentinfo.IC, studentinfo.PhoneNum, studentinfo.gender from login join studentinfo 
            where login.TypeName= 'student' AND login.status= 'inactive' AND login.UserID=studentinfo.UserID GROUP BY login.UserID;";
