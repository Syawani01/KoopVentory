...
$UserID = $_GET['UserID'];
$mysqli_page = $db->query("select login.FullName, login.UserID, studentinfo.email, studentinfo.IC, studentinfo.PhoneNum, studentinfo.gender from login join studentinfo where login.UserID= '$UserID' 
                AND login.UserID=studentinfo.UserID;");
...
if(isset($_POST["edit"])){
  ...
  $data = "FullName:".$Name.";"."gender:".$Gender.";"."Email:".$Email.";"."Phone:".$PhoneNum.";"."IC:".$IC.";"; 

  $sql ="update studentinfo set gender='".$gender."', email='".$emailencrypted."', PhoneNum='".$Numencrypted."', IC='".$ICencrypted."' where UserID='".$UserID."'";
  $mysqli->query($sql);
...
<nav style="justify-content: space-between;align-items:center">
    ...
    <div class="header">
      ...
      <a href="#" class=""  ><h1><b>KoopVentory : Edit Student</b></h1></a>
    </div>
...
<div class="header-right">
  ...
  <a class="active" href="StudentV1.php?UserID=<?php echo $UserID; ?>">Previous Version</a>
</div>
...
<div style="width:75%;margin:0 auto">
    ...
    <input type="text" name="id" class="form-input" placeholder="" value="<?php echo $UserID?>" disabled>
    <br>
    <br>
    <label>Name</label>
    <input type="text" name="name" class="form-input" placeholder="" value="<?php echo $Name?>" disabled>
    <br>
    <br>
    <label>Gender</label>
