...
if (isset($_POST["add"])) {
  ...
  if($name=='Select Product'){
    if(empty($code)){
      echo '<script>alert ("Please enter Product nama or code");window.location.href = "AddStock.php";</script>';
    }else{
      ...
      if ($mysqli_page->num_rows > 0){
        ...
        if ($run_banners) {
          echo '<script>alert ("Successfully add '.$name.'stock");window.location.href = "Inventory.php";</script>';
        }else {
    ...
    if ($mysqli_page->num_rows > 0){
      ...
      $run_banners = query($get_banner,[$newQuan,$expired,$date_in, $stock['ProductID']]);
      if ($run_banners) {
        echo '<script>alert ("Successfully add stock");window.location.href = "Inventory.php";</script>';
      }else {
        echo '<script>alert ("FAIL! Please try again.");window.location.href = "Inventory.php";</script>';
      }
    }
