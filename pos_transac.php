...
if(empty($_SESSION["cart_item"])) {
  echo '<script>alert ("The chart is empty");window.location.href = "POS.php";</script>';
}else{
  $date = $_POST['date'];
  $total = $_POST['total'];
  $cash = $_POST['cash'];
  ...
  echo '<script>alert ("Successfull Payment. Balance : RM '.$balance.'");window.location.href = "POS.php";</script>';
  }
