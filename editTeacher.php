...
$UserID = $_GET['UserID'];
$mysqli_page = $db->query("select login.FullName, login.UserID, teacherinfo.email, teacherinfo.IC, teacherinfo.PhoneNum, teacherinfo.gender from login join teacherinfo where login.UserID= '$UserID';");
...
if(isset($_POST["edit"])){
    ...
    $sql ="update teacherinfo set gender='".$gender."', email='".$emailencrypted."', PhoneNum='".$Numencrypted."', IC='".$ICencrypted."' where UserID='".$UserID."'";
    $mysqli->query($sql);
...
<nav style="justify-content: space-between;align-items:center">
    ...
    <div class="header">
      ...
      <a href="#" class=""  ><h1><b>KoopVentory : Edit Teacher</b></h1></a>
    </div>
...
<div class="header-right">
  ...
  <a class="active" href="TeacherV1.php?UserID=<?php echo $UserID; ?>">Previous Data</a>
</div>
...
<div style="width:75%;margin:0 auto">
    ...
    <br>
    <label>Name</label>
    <input type="text" name="name" class="form-input" placeholder="" value="<?= $Name?>" disabled>
    <br>
    <br>
    <label>Gender</label>
